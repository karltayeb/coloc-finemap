...
rule ukbb_saige_gtex_cafeh_truncated:
    input:
        genotype_gtex = 'output/GTEx/{chr}/{gene}/{gene}.raw',
        associations = 'output/GTEx/{chr}/{gene}/{gene}.associations',
        sumstats='output/UKBB/{phenotype}/{phenotype}.tsv.bgz',
        v2r = 'output/GTEx/{chr}/{gene}/{gene}.snp2rsid'
    output:
        variant_report='output/UKBB/{phenotype}/{chr}/{gene}/{gene}.{phenotype}.z3.variant_report',
        coloc_report='output/UKBB/{phenotype}/{chr}/{gene}/{gene}.{phenotype}.z3.coloc_report',
        model='output/UKBB/{phenotype}/{chr}/{gene}/{gene}.{phenotype}.z3.css'
    run:
        import pysam
        import pandas as pd
        import numpy as np
